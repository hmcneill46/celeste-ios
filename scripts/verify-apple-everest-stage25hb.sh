...
"$SCRIPT_DIR/test-apple-everest-il-compose.sh"
"$SCRIPT_DIR/test-apple-everest-desktop-hookgen.sh"
"$SCRIPT_DIR/test-apple-everest-desktop-modinterop.sh"
exec python3 "$SCRIPT_DIR/verify-apple-everest-stage25hb.py" "$@"
