...
| [ConditionHelper](https://github.com/Brokemia/ConditionHelper) | Ignored Stage 25F-B/B2 provider release fixture and source audit at `1d42c6a7…9dd` | MIT; copyright Brokemia and contributors. Its ZIP, DLL, ExpressionParser dependency, content, and source are not tracked or redistributed. |
| [AchievementHelper](https://github.com/Brokemia/AchievementHelper) | Ignored Stage 25F-B/B2 consumer release fixture and source audit at `6f8bb780…483b` | MIT; copyright Brokemia and contributors. Its ZIP, DLL, content, and source are not tracked or redistributed. The tracked B2 achievement definition is project-owned data. |
| [Dash Toggle Helper](https://github.com/kyfex-uwu/DashToggleHelper) | Ignored Stage 25H release fixture and source audit at `9b140684…530c` | MIT; copyright kyfex-uwu and contributors. Its ZIP, DLL, content, and source are not tracked or redistributed. |
