    ...
    [
        ...
        new("communalhelper-1.25.5-henny-v1", "CommunalHelper", "1.25.5",
            ...
            [
                ...
                new("entity", "CommunalHelper/PlayerBubbleRegion", "player-bubble-region", "new AppleEverestPlayerBubbleRegion(data, offset)", true)
            ], [], [], RuntimeFiles: ["AppleEverestPlayerBubbleRegion.cs"]),
        new("maxhelpinghand-1.40.9-henny-v1", "MaxHelpingHand", "1.40.9",
            ...
            [
                ...
                new("entity", "MaxHelpingHand/FlagSwitchGate", "flag-switch-gate", "new AppleEverestFlagSwitchGate(data, offset, entityId)", true),
                new("entity", "MaxHelpingHand/FlagTouchSwitch", "flag-touch-switch", "new AppleEverestFlagTouchSwitch(data, offset, entityId)", true),
        ...
        new("contorthelper-1.5.5-sj-beginner-v1", "ContortHelper", "1.5.5",
            ...
            [new("trigger", "ContortHelper/MadelineSpotlightModifierTrigger", "madeline-spotlight-modifier",
             ...
             new("trigger", "ContortHelper/RandomSoundTrigger", "random-sound-trigger",
                "new AppleEverestRandomSoundTrigger(data, offset, entityId)", true)],
            [], [], RuntimeFiles: ["AppleEverestContortSemantics.cs", "AppleEverestRandomSoundTrigger.cs"]),
