...
namespace Celeste.Mod {
    ...
    /// </summary>
    internal sealed class AppleEverestCollabMemorialText : Entity {

        public Entity Memorial;
        ...
        public AppleEverestCollabMemorialText(Entity memorial, bool dreamy, string text, float spacing)
            : base() {
