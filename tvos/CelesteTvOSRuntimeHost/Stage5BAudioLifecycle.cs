...
internal sealed class Stage5BAudioLifecycle : IDisposable
{
    private readonly List<NSObject> observers = new();

    public Stage5BAudioLifecycle()
    {
        ...
        Observe(UIApplication.WillEnterForegroundNotification, _ => Stage3BLog.Info("Stage5B audio lifecycle: foreground entering"));
